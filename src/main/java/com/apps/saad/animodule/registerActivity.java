...
public class registerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                {
                    Toast.makeText(getApplicationContext(), "Password must contain at least one special character, an uppercase and a lowercase letter and at least one number!", Toast.LENGTH_LONG).show();
                    return;
                }
    ...
    public boolean passValidator(String password)
    {
        Pattern pattern;
        Matcher matcher;
        final String PASS_PATTERN = "^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%&*()_+=|<>?{}\\[\\]~-]).{8,}$";
